({
    doInit : function(component,event,helper)
    {
        ...
        component.set("v.rcpt.Receipt_Name__c", 'Booking Amount Receipt');
        ...
        var action=component.get("c.getpaymentscBook");
        ...
        var bookamount = component.get('v.BookingAmount');
        component.set('v.ActualAmppuntBookingAmount',bookamount);
    },
    ...
    quoteSave: function(component,event,helper) {
        /*var banName = component.get("v.rcpt.Bank_Name__c").trim();
        var transactionNumber = component.get("v.rcpt.Cheque_no_Transaction_Number__c").trim();
        component.set("v.savebuttonhide",true);
    ...
    getGrandTotal : function(component, event, helper) {
        ...
        var index = event.currentTarget.dataset.record;
        var oitems= component.get('v.recptItemList');
        var limitAmount = component.get('v.ActualAmppuntBookingAmount');
        component.set('v.recptItemList',oitems);
        var grandtotal = 0;
        var pendingtotal = 0;
        var oit= component.get('v.recptItemList');
        ...
        pendingtotal = parseFloat(component.get('v.ActualAmppuntBookingAmount')) - parseFloat(grandtotal);
        if (parseFloat(grandtotal) > parseFloat(component.get('v.ActualAmppuntBookingAmount'))) {
            helper.showToast("Received Amount cannot exceed the Maximum Amount", "error");
            component.set('v.savebuttonhide',false);
        }
        else{
            component.set('v.savebuttonhide',true);
        ...
        component.set('v.totalPending',pendingtotal);
